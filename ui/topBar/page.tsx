...
export default function TopBar({ name }: ProductNavBarProps) {
  ...
  return (
    <div className='flex items-center justify-between rounded-xl h-16 px-4 py-4 mx-3'>
      ...
      <div className='flex items-center transition cursor-pointer duration-300 ease-in-out transform hover:scale-105'>
        <div className='text-lg text-blue-600 font-semibold mr-4'>Hi, username!</div>
        <img
