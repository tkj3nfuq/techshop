...
interface VoucherSelectedProductCardProps {
    product: product,
    index: number,
    setSelectedProducts: React.Dispatch<React.SetStateAction<product[]>>
}

export default function VoucherSelectedProductCard({ product, index, setSelectedProducts }: VoucherSelectedProductCardProps) {
            ...
            <Popup
                ...
                <div className='modal flex flex-col text-black bg-white p-3 rounded-xl max-w-3xl'>
                    <div className='flex flex-row justify-between mb-2 '>
                        <div className='header font-bold text-xl'>Product's Selected</div>
